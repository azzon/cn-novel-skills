...
PREFIX = (
    ...
    "【反AI指纹(平台检测硬红线)】段落长短必须剧烈错落:每章至少3个超短独立段(≤5字)+3个长段(≥80字);段长方差>40。禁连续5段字数接近(±15字内);对话标签多变(说/回/喊/嘟囔/没接话,禁连续"他说")。【代入感引擎】每千字≥1条主角感官记忆闪回(气味/声音/触觉画面,非情节复述,如'忽然想起小时候外婆灶台的柴火味')。【付费意愿引擎】每章≥2个"读者会截图发群"的高光拍(全场愣住/拍桌叫好/炸了围观);章末必须让读者生理性想翻下一章。【防同构】对白禁复盘腔;讲解问答每章<=1次;章末禁议论;本章至少一处失控/失败/意外。"
